...
return new class extends Migration
{
    ...
    {
        Schema::create('kutipan_dua_akta_perceraian', function (Blueprint $table) {
            $table->id();
            $table->string('nomor')->nullable();
            $table->string('kode', 50);
            $table->string('nomor_akta'); // Nomor akta sebelumnya
    ...
    {
        Schema::dropIfExists('kutipan_dua_akta_perceraian');
    }
};
