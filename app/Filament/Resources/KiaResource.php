...
use App\Filament\Resources\KiaResource\Pages;
use App\Models\Kia;
use App\Models\User;
...
class KiaResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'KIA';

    protected static ?string $modelLabel = 'KIA';

    protected static ?string $pluralModelLabel = 'KIA';
    ...
    public static function form(Form $form): Form
    {
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('Informasi KIA')
                    ->description('Data KIA')
                    ->schema([
    ...
    {
        return [
            'index' => Pages\ListKias::route('/'),
            'create' => Pages\CreateKia::route('/create'),
            'view' => Pages\ViewKia::route('/{record}'),
            'edit' => Pages\EditKia::route('/{record}/edit'),
        ];
    }
}
