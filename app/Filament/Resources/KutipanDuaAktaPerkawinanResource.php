...
use App\Filament\Resources\KutipanDuaAktaPerkawinanResource\Pages;
use App\Models\KutipanDuaAktaPerkawinan;
use App\Models\User;
...
class KutipanDuaAktaPerkawinanResource extends Resource
{
    protected static ?string $model = KutipanDuaAktaPerkawinan::class;

    protected static ?string $navigationIcon = 'heroicon-o-document-duplicate';

    protected static ?string $navigationLabel = 'Kutipan Dua Akta Perkawinan';

    protected static ?string $modelLabel = 'Kutipan Dua Akta Perkawinan';

    protected static ?string $pluralModelLabel = 'Kutipan Dua Akta Perkawinan';
    ...
    public static function form(Form $form): Form
    {
        ...
        return $form
            ->schema([
                Forms\Components\Section::make('Informasi Kutipan Dua Akta Perkawinan')
                    ->description('Data kutipan dua akta perkawinan')
                    ->schema([
                        ...
                        Forms\Components\Select::make('kode')
                            ->label('Kode')
                            ->options(KutipanDuaAktaPerkawinan::getKodeOptions())
                            ->required()
                            ->searchable()
                ...
                Forms\Components\Section::make('Status & Produk')
                    ...
                    ->schema([
                        ...
                        Forms\Components\FileUpload::make('file_produk')
                            ...
                            ->directory('kutipan-dua-akta-perkawinan/files')
                            ->preserveFilenames()
                            ->disk('local')
                            ->visibility('private')
                            ->downloadable()
    ...
    {
        return [
            'index' => Pages\ListKutipanDuaAktaPerkawinans::route('/'),
            'create' => Pages\CreateKutipanDuaAktaPerkawinan::route('/create'),
            'view' => Pages\ViewKutipanDuaAktaPerkawinan::route('/{record}'),
            'edit' => Pages\EditKutipanDuaAktaPerkawinan::route('/{record}/edit'),
        ];
    }
}
