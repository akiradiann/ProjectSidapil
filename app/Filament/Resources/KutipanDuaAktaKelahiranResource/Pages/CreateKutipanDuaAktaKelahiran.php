...
class CreateKutipanDuaAktaKelahiran extends CreateRecord
{
    ...
    protected function afterCreate(): void
    {
        ...
        // Get kategori layanan for Kutipan Dua Akta Kelahiran
        $kategoriLayananId = KategoriLayanan::where('nama_kategori', 'KUTIPAN DUA KELAHIRAN')->first()?->id ?? 5;
