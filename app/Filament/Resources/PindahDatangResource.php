...
use App\Filament\Resources\PindahDatangResource\Pages;
...
class PindahDatangResource extends Resource
{
    protected static ?string $model = PindahDatang::class;

    protected static ?string $navigationIcon = 'heroicon-o-arrow-right-circle';

    protected static ?string $navigationLabel = 'Pindah Datang';

    protected static ?string $modelLabel = 'Pindah Datang';

    protected static ?string $pluralModelLabel = 'Pindah Datang';
    ...
    public static function form(Form $form): Form
    {
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Section::make('Informasi Pindah Datang')
                    ->description('Data pindah datang')
                    ->schema([
                        ...
                        Forms\Components\Select::make('ajuan')
                            ->label('Ajuan')
                    ...
                    ->schema([
                        Forms\Components\CheckboxList::make('checklist_persyaratan')
                            ...
                            ->options([
                                ...
                                'KTP-el Kepala Keluarga/Pemohon' => 'KTP-el Kepala Keluarga/Pemohon',
                                'Surat Keterangan Pindah dari Daerah Asal' => 'Surat Keterangan Pindah dari Daerah Asal',
                                'Surat Pengantar RT/RW' => 'Surat Pengantar RT/RW',
                                'Pas Foto 3x4 (2 lembar)' => 'Pas Foto 3x4 (2 lembar)',
                            ])
                            ->bulkToggleable()
                            ->columns(1)
                    ])
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('ajuan')
                    ->label('Ajuan')
                    ->badge()
                    ->color(fn($record) => match ($record->ajuan) {
                        'KEPINDAHAN' => 'warning',
                        'KEDATANGAN' => 'success',
                        default => 'gray',
                    })
            ...
            ->filters([
                ...
                Tables\Filters\SelectFilter::make('produk_id')
                    ...
                    ->multiple(),
                Tables\Filters\SelectFilter::make('ajuan')
                    ->label('Ajuan')
                    ->options(PindahDatang::getAjuanOptions())
                    ->multiple(),
            ...
            ->emptyStateHeading('Belum ada pindah datang')
            ->emptyStateDescription('Mulai dengan membuat pindah datang baru.')
            ->emptyStateActions([
    ...
    {
        return [
            'index' => Pages\ListPindahDatangs::route('/'),
            'create' => Pages\CreatePindahDatang::route('/create'),
            'view' => Pages\ViewPindahDatang::route('/{record}'),
            'edit' => Pages\EditPindahDatang::route('/{record}/edit'),
        ];
    }
}