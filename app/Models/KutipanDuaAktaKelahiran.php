...
class KutipanDuaAktaKelahiran extends Model
{
    protected $table = 'kutipan_dua_akta_kelahiran';
    ...
    const KODE_AKL_K2 = 'AKL/K2';
    const KODE_AKL_PB = 'AKL/PB';
    const KODE_AKL_BTL = 'AKL/BTL';

    public static function getKodeOptions(): array
    {
        return [
            self::KODE_AKL_K2 => self::KODE_AKL_K2,
            self::KODE_AKL_PB => self::KODE_AKL_PB,
            self::KODE_AKL_BTL => self::KODE_AKL_BTL,
        ];
    }
    ...
    protected static function boot()
    {
        ...
        static::deleting(function ($kutipan) {
            // Delete related ServiceRequest when KutipanDuaAktaKelahiran is deleted
