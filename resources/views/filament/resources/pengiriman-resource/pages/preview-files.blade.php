                            ...
                            <div class="p-2 border rounded {{ request('file') == $file['path'] || (request('file') === null && $index === 0) ? 'bg-blue-50 border-blue-200' : 'bg-white' }}">
                                ...
                                <div class="flex items-center gap-1">
                                    <a href="{{ $file['downloadUrl'] }}" 
                                       ...
                                       class="flex-1 inline-flex items-center justify-center gap-1 px-1.5 py-1 text-xs font-medium text-white bg-green-600 rounded hover:bg-green-700 transition-colors"
                                    ...
                                    <button type="button"
                                            onclick="window.location.href='?file={{ urlencode($file['path']) }}'"
                                            class="inline-flex items-center justify-center px-1.5 py-1 text-xs font-medium text-blue-600 bg-blue-50 rounded hover:bg-blue-100 transition-colors"
